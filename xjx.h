...
extern std::map<uint, uint>
	asm_reference; // maps assembler to microcode address
extern uint
	mur[3]; // microcode update register, stores mc_addr, mop, asm_reference
...
/**
 * @brief updateAsmRef Inserts or updates an ASM -> MicroCode address reference
 * from the MUR
 */
void murToMC();
